      ...
      <div className="flex items-center justify-between w-full px-4 md:px-6 py-3">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          ...
          <button
            ...
            className="px-4 py-2 bg-white/20 border border-white/30 rounded-md text-sm text-white hover:bg-white/30 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {getButtonText()}
          </button>
        </div>
